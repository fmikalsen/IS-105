...
def lab3_scripts():
	...
	subprocess.call("./test1.pl", shell=True)
...
#	byteorder: little
#	os data: 
#	('Linux', 'dracz-MS-7680', '3.2.0-58-generic', '#88-Ubuntu SMP Tue Dec 3 17:37:58 UTC 2013', 'x86_64')
#	os bruker: dracz
...
def initialer(navn):
	...
	# Til bokstavene ved bruk av; navn.find("F") evt navn.find("M", 6)
...
print 5*"-" + " initialer() " + 5*"-"
print initialer("Frode Mikalsen")

print 5*"-" + " infix_to_prefix() " + 5*"-"
print infix_to_prefix("2 * 55")
